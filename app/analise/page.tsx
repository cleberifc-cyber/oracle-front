      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        {!acessoLiberado && !imagemFinal && !loading && (
          <div className="bg-[#161b22] border border-[#30363d] rounded-[48px] p-20 text-center space-y-8 shadow-2xl">
            <h2 className="text-4xl font-black text-white italic italic tracking-tighter">LIBERAR TERMINAL</h2>
            <div className="max-w-sm mx-auto space-y-4">
              <input type="text" placeholder="CÓDIGO (OPCIONAL)" value={cupom} onChange={(e)=>setCupom(e.target.value)} className="w-full bg-[#0d1117] border border-[#30363d] p-5 rounded-2xl text-center text-white" />
        ...
        {loading && <div className="text-center py-20 animate-pulse text-[#0070f3] font-black tracking-widest">SINCRONIZANDO SISTEMAS...</div>}
        ...
        {imagemFinal && (
          <div className="space-y-8 pb-20 animate-in zoom-in duration-500">
            <div className="relative rounded-[40px] overflow-hidden border border-[#30363d] bg-[#161b22] p-4 shadow-2xl">
              ...
              <div className="absolute top-10 left-10 bg-[#0070f3] text-white px-6 py-2 rounded-full text-[10px] font-black uppercase">Veredito Sniper v9.1</div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 bg-[#161b22] p-10 rounded-[40px] border border-[#30363d]">
                ...
                <p className="text-[#e6edf3] text-lg italic leading-relaxed bg-[#0d1117] p-6 rounded-2xl border border-[#30363d]">"{analise.justificativa}"</p>
